...
int main() {
    ...
    // N - мерен масив, намерете елемент k и следете индекса му ако няма елемнти изведдете -1
//
//    int n;
//    char k;
//
...
//    std::cout << "Max: " << max << " Min: " << min << std::endl;
    ...
    // Намерете най-малкият елемент в масива и изведете индексите на които се намира той.
//
//    int n;
//    int min;
//
